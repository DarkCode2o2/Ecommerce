      ...
      <div class="flex flex-wrap mb-24 -mx-3">
        <div class="w-full pr-2 lg:w-1/4 lg:block">
            ...
            <ul>
              <li class="mb-4">
                <label for="isFeatured" class="flex items-center dark:text-gray-300">
                  <input type="checkbox" id="isFeatured" wire:model.live="featured" class="w-4 h-4 mr-2">
                  <span class="text-lg dark:text-gray-400">Featured Products</span>
                </label>
              </li>
              <li class="mb-4">
                <label for="onSale" class="flex items-center dark:text-gray-300">
                  <input type="checkbox" id="onSale" wire:model.live="sale" class="w-4 h-4 mr-2">
          ...
          <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
            ...
            <div class="w-16 pb-2 mb-6 border-b border-rose-600 dark:border-gray-400"></div>
            <div>
              <h3 class="text-blue-500 font-semibold">{{ Number::currency($price_range) }}</h3>
              <input type="range" wire:model.live="price_range" class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer" max="10000" value="5000" step="100">
              <div class="flex justify-between ">
                <span class="inline-block text-lg font-bold text-blue-400 ">{{Number::currency(100)}}</span>
                <span class="inline-block text-lg font-bold text-blue-400 ">{{Number::currency(10000)}}</span>
              </div>
            </div>
          </div>
        </div>
                  ...
                  <div class="border border-gray-300 dark:border-gray-700">
                    <div class="relative bg-gray-200">
                      <a href="/products/{{ $product->slug }}">
                        <img src="{{ asset('storage/'.$product->images[0]) }}" alt="" class="object-cover w-full h-56 mx-auto ">
                      </a>
                    </div>
                    <div class="p-3 ">
                    ...
                    <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">
                      ...
                      <a wire:click.prevent="addToCart({{ $product->id }})" href="#" class="text-gray-500 flex items-center space-x-2 dark:text-gray-400 hover:text-red-500 dark:hover:text-red-300">
                          ...
                          <span wire:loading.remove wire:target="addToCart({{ $product->id }})">Add to Cart</span><span wire:loading.class="inline-block" class="hidden" wire:target="addToCart({{ $product->id }})">Adding....</span>
