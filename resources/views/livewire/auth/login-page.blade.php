        ...
        <div class="p-4 sm:p-7">
          ...
          <form wire:submit.prevent="login" class="mt-4">
            <div class="grid gap-y-4">
              @if (session('success'))
                <div class="mt-2 bg-green-500 text-sm text-white rounded-lg p-4" role="alert" tabindex="-1" aria-labelledby="hs-solid-color-danger-label">
